  ...
  <div class="min-h-screen bg-slate-100 text-slate-900">
    <header class="border-b border-slate-200 bg-white">
      <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        <div>
          <p class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">ADA Inventory</p>
    ...
    <div class="mx-auto grid max-w-7xl gap-4 px-4 py-4 sm:px-6 lg:grid-cols-[16rem_1fr] lg:px-8">
      <aside class="rounded-xl border border-slate-200 bg-white p-4">
        <p class="mb-2 text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Navigation</p>
        <nav class="space-y-2">
          <RouterLink
            to="/"
